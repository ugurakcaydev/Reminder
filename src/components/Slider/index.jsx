        ...
        <div className='w-full mb-10'>
            ...
            >
                ...
                {userComments && userComments.map((card) => (
                    ...
                    <SwiperSlide key={card._id} className=' bg-[#fbfbfb] rounded-3xl shadow-lg  flex justify-center  py-4  desktop1:px-5 desktop2:px-4'>
                        <div className='max-w-[90%] flex  flex-col items-center text-justify gap-y-14  break-words '>
                            <span className='font-ubuntu text-xs desktop2:text-sm'>"{card.comment}"</span>

...
export default function Footer() {
  ...
  return (
    <div className="  w-full  bg-[color:var(--bg-base-secondary)]">
      <footer className=" body-font w-full ">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a className="flex title-font font-medium items-center md:justify-start justify-center ">
              ...
              <span className="ml-3 text-xl text-[color:var(--color-base)]">YouCanBookMe</span>
            </a>
        ...
        <div className="bg-[#2a2a2a]">
          <div className="container flex flex-wrap flex-col items-center mx-auto py-2 px-5  sm:flex-row">
            <p className=" text-gray-300 text-sm text-center sm:text-left">
              © {currentTime.getFullYear()} | TeamFives
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start gray-300">

    ...
    return (
        <div className='w-full h-[100vh] flex flex-col items-center'>
            <div className='desktop2:w-6/12 desktop1:w-7/12'>
                <div className=' w-full min-h-[155px] flex gap-x-4 p-3 mb-10 shadow-md shadow-[color:var(--bg-secondary)] rounded-2xl bg-[color:var(--bg-base-secondary)]'>
                    ...
                    <div className='w-full h-auto flex flex-col gap-y-2 pl-4 border-l border-[#d7d7d7]'>
                        ...
                        <div className='flex justify-between'>
                            ...
                            />
                            <div>
                                <button className='font-poppins py-2 px-4 rounded-full border border-[color:var(--bg-secondary)] transition-all hover:bg-[color:var(--bg-base)] hover:text-[color:var(--color-basse)] hover:scale-90' onClick={handleSendComment}>
                                    Gönder
                                </button>
                            </div>
                        </div>
                ...
                <div className='w-full text-center text-xl font-bold font-sans pb-2'> Kullanıcı Yorumları</div>

                {allComments.map((comment, index) => (
                    <><div key={index} className='w-full flex gap-x-4 p-3 mb-5 shadow-md shadow-[color:var(--bg-secondary)] bg-[color:var(--bg-base-secondary)] rounded-2xl'>
                        ...
                        <div className='w-full flex flex-col gap-y-1   text-justify break-words   pl-2 border-l border-[#d7d7d7]'>
                            <span className='text-[color:var(--color-base)] font-bold  text-base'>{comment.userName}</span>
                            ...
                            <div className='flex justify-between'>
                                ...
                                <div className='text-[color:var(--color-base-secondary)] font-roboto text-xs'>{exampleDay.toLocaleDateString()}</div>
                            </div>
                        </div>
                    </div>
                    </>
